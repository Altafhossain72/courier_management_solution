...
//import application.Main;
import application.Courier_ManageMent_system;
	...
	public void login() {
		...
		try {
			...
			//}// else {
				...
				root = (AnchorPane)FXMLLoader.load(getClass().getResource("Customer.fxml"));
			
			Scene scene = new Scene(root);
			Courier_ManageMent_system.stage.setScene(scene);
			Courier_ManageMent_system.stage.setTitle("Home");
		} catch(Exception e) {
